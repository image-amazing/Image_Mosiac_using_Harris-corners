...
% Load images.
buildingDir = fullfile('/','home','mithun','hw_robs','hw6','Fifth_grafiti15percentnew','undistort');
...
[y,x] = harris(grayImage,30000,'tile',[1 1],'disp');
...
for n = 2:numImages
    ...
    [y,x] = harris(grayImage,30000,'tile',[1 1],'disp');
    points=cornerPoints([x,y]);
    [features, points] = extractFeatures(grayImage, points);    % Find correspondences between I(n) and I(n-1).
